    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-white to-amber-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-10 flex items-center gap-3">
              <div className="w-12 h-12 bg-[#ffbe00] rounded-xl flex items-center justify-center shadow-lg">
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col justify-between min-w-0">
                    <div className="pr-1 sm:pr-8 mb-2 sm:mb-4">
                      ...
                      <p className="text-xl sm:text-2xl font-extrabold text-black bg-clip-text text-left">
                      ...
                      <div className="flex items-center gap-4 mt-auto">
                        ...
                        <button
                          ...
                          className="flex items-center  gap-1 py-2.5 px-3 rounded-lg border border-gray-200 bg-white text-sm text-gray-400 font-medium hover:text-gray-500 hover:bg-gray-100 shadow-sm"
                        >
                          <Trash2 size={16} />
                        </button>
                  ...
                  <button
                    onClick={() => removeItem(item._id)}
                    className="hidden sm:flex absolute right-6 top-6 p-2.5 text-gray-400 hover:text-gray-500 hover:bg-gray-100 rounded-xl transition-all"
                    title="Remove item"
                  >
                    <Trash2 size={20} />
                  </button>
